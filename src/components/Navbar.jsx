    ...
    <span className="text-xl font-bold text-black">Creative World</span>
      ...
      {isOpen && (
        <div className="absolute top-16 left-0 w-full flex flex-col space-y-4 py-6 px-6 md:hidden bg-white">
          ...
          <a href="#portfolio" className="text-gray-500 pl-4">Portfolio</a>
          <a href="#projects" className="text-gray-500 pl-4">Projects</a>
          <a href="#team" className="text-gray-500 pl-4">Team</a>
          ...
          <a href="#pricing" className="text-gray-500 pl-4">Pricing</a>
