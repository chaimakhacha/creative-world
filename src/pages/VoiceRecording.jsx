      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        >
          ...
          <p className="mt-4 text-lg text-white/90 max-w-2xl mx-auto">
            Expert voice-over services for commercials, audiobooks,
            e-learning, and multimedia content with native and international
            talent.
          </p>
        </motion.header>
        ...
        <section className="mb-24">
          <h2 className="text-3xl font-semibold text-center text-blue-200 mb-6">
            What We Offer
          </h2>
          <p className="text-center text-gray-100/80 mb-10">
            Comprehensive voice service solutions tailored to your unique needs
            and vision.
          </p>
        ...
        <section className="mb-24">
          ...
          <p className="text-center text-gray-100/80 mb-10">
            Our proven artistic methodology ensures exceptional results for
            every project.
          </p>
