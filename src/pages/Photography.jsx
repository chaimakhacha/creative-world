    ...
    <div className="relative min-h-screen text-gray-900 ">
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        >
          ...
          <h1 className="text-5xl font-extrabold text-white tracking-tight">Photography</h1>
          <p className="mt-4 text-lg text-white/90 max-w-2xl mx-auto">
            Capturing Moments That Tell Your Story
            <br />
            Professional photography capturing moments and products with artistic vision and
            technical excellence using industry-standard equipment.
          </p>
        </motion.header>
        ...
        <section className="mb-24">
          <motion.h2
            className="text-3xl font-semibold text-center text-rose-200 mb-6"
          ...
          <motion.p
            className="text-center text-gray-100/80 mb-10"
            initial={{ opacity: 0 }}
              ...
              >
                ...
                <div className="bg-white/85 rounded-2xl shadow-lg p-6 min-h-[120px] relative overflow-hidden">
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 rounded-lg flex items-center justify-center border border-rose-100 bg-rose-50/80">
                      <Check size={18} className="text-rose-600" />
                    </div>
                    <div className="flex-1">
                      <h3 className="text-rose-700 text-[22px] font-semibold">{o.title}</h3>
                    </div>
                  </div>
                </div>
              </motion.article>
        ...
        <section className="mb-24">
          <h2 className="text-3xl font-semibold text-center text-rose-200 mb-6">
            Our Creative Process
          </h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      aria-hidden
                    >
                      <div className="w-5 h-5 rounded-full bg-white border-4 border-rose-200 shadow-sm" />
                    </div>
                        ...
                        {isLeft && (
                          <div className="bg-white/90 rounded-xl p-6 shadow-md">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-md flex items-center justify-center bg-rose-50 border">
