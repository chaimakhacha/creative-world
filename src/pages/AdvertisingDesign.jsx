      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        >
          <div className="flex justify-center mb-6">
            <div className="bg-red-900/30 p-4 rounded-full inline-flex border border-red-600">
              <Megaphone size={36} className="text-red-400" />
            </div>
          </div>
        ...
        <section className="mb-24">
          <motion.h2
            className="text-3xl font-semibold text-center text-red-400 mb-6"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7 }}
          >
          ...
          >
            {offers.map((o, i) => (
              <motion.article
                key={i}
                className="relative bg-white/10 backdrop-blur-sm border border-white/10 rounded-2xl shadow-lg p-6 hover:scale-[1.02] transition-transform"
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: i * 0.1 }}
              >
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-lg flex items-center justify-center border border-red-400/40 bg-red-400/10">
                    <Check size={18} className="text-red-400" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-red-300 text-[20px] font-semibold">{o.title}</h3>
                  </div>
                </div>
              </motion.article>
            ))}
        ...
        <section className="mb-24">
          ...
          <div className="relative">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 top-6 bottom-6 w-[2px] bg-gradient-to-b from-red-400/40 to-transparent" />
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      aria-hidden
                    >
                      <div className="w-5 h-5 rounded-full bg-red-400 border-4 border-red-200 shadow-sm" />
                    </div>
                    ...
                    >
                      ...
                      <div className={`w-full md:w-1/2 ${isLeft ? "md:mr-16" : "md:ml-16"}`}>
                        {isLeft && (
                          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-md border border-white/10">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-md flex items-center justify-center bg-red-400/10 border border-red-400/40">
                                <Icon size={18} className="text-red-400" />
                              </div>
                              <div>
                                <h4 className="font-semibold text-red-300">{step.title}</h4>
